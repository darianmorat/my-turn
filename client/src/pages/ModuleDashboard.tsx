...
import { UserCheck, CheckCircle, Users, Phone, Plus, X, RefreshCcw } from "lucide-react";
         ...
         <div className="min-h-screen">
            ...
            <div className="mb-6">
               <div className="flex flex-col items-center justify-center gap-4">
                  <h1 className="text-2xl font-bold">Panel de Gestión de Módulos</h1>
            ...
            {/* Acciones rápidas */}
            <div className="mt-8 rounded-md shadow p-6 border bg-card">
